...
exec run $1:$3_outer_ring = $2:$3_1 - $3:$2
exec run $1:$3_inner_ring = $3:$2 - $1:$3_2
exec run $1:$3_ring_and1  = $1:$3_outer_ring * $2:$3
exec run $1:$3_ring_intersection  = $1:$3_outer_ring * $1:$3_inner_ring
exec run nothing = $1:$3_ring_and1 ASSERT_ZERO $1:nothing
exec run nothing = $1:$3_ring_intersection ASSERT_ZERO $1:nothing')dnl
