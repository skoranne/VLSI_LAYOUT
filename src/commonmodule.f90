...
contains
  ...
  subroutine beep()
    ! The 'advance="no"' option prevents the automatic newline
    write(*, '(A)', advance='no') achar(7)
    ! Optional: Flush the output to ensure the system processes the char immediately
    call flush(6) 
  end subroutine beep
